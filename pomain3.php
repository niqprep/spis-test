				...
				?>	
					<div>	
							...
							<tr>
								...
								<td colspan="1">
									<input type="text" name="conforme"   disabled />
									  ...
									  <?php
									  	//echo '<select name="conforme" form="poform" disabled>';
						...
						<table  id="tablediv" cols="3" >
							...
							<!--<tr id="subcatdd">
								<td id="tdlabel"><label for="status"> Status of RIS<strong>*</strong> </label></td>
								<td>
									<select name="ris_status" form="poform" disabled>
									  <option value="nyissued" selected="selected">Not yet issued</option>
									  <option value="issued">Issued</option>
									  <option value="pissued">Partially issued</option> 
									</select>
								</td>
							</tr>--!>
							<tr>
							...
							<!--
							<tr>
								<td id="tdlabel"><label for="dept">Department/Division<strong>*</strong></label></td>
							...
							<tr>
								...
								<td colspan="2">	
									<!-- <input type="text" name="sect" id="sect" required /> --!>
