...
<html>
	<head>
		...
		<script type="text/javascript">
		    ...
		    function descr() 
		    {
		    var x = document.getElementsByName("item")[0];
									...
									<form name="logno" id="rcv" method="post" action="addbidsuppitem_proc.php">
											...
											<table id="popuptbl" >
												<tr> 
													...
													<td><select name="item" id="datetime" onchange="descr()" autofocus required>';
															for ($i=0; $i < $ctr; $i++)
															{ 
																echo '	<option value="'.$itemid[$i].'+'.$cat[$i].'">'.$item_name[$i].' '.$desci[$i].' '.$brand[$i].', '.$unit[$i].' </option>';
															}
												...
												<tr> 
													<td >Unit Price</td>
													<td >
														<input type="number" name="uprice" id="datetime" required>
													</td>
												</tr><tr> 
													<td >Status</td>
													<td >
