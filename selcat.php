...
<html>
	...
	echo '	<div id="mbody" >
				...
				<form name="select" id="select" method="post" action="addstock.php">
					<ul>
					 	<li><a href="index.php" title="Go to Home page">Dashboard</a></li>|
					 	<li><a href="issuehkofc.php" title="Issue House Keeping and Office Supplies">Issue HK and Ofc Supplies</a></li>|
					 	<li><a href="selcat2.php" title="Issue other supplies">Issue Other Supplies</a></li>|
